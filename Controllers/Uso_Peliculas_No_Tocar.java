...
import ENUM.Genero;
import ENUM.Pegi;
import Models.Pelicula_No_tocar;
...
public class Uso_Peliculas_No_Tocar {
    public static void main(String[] args) {
        ...
        Pelicula_No_tocar LaComunidadDelAnillo = new Pelicula_No_tocar("El señor de los anillos: La comunidad del anillo", Genero.AVENTURA_FANTASIA, 2001, "228", "Peter Jakson", repartoESDLA_1_2_3, Pegi.DOCE, 4);
        Pelicula_No_tocar LasDosTorres = new Pelicula_No_tocar("El señor de los anillos: Las dos torres", Genero.AVENTURA_FANTASIA, 2002, "259", "Peter Jakson", repartoESDLA_1_2_3, Pegi.TRECE, 4);
        Pelicula_No_tocar ELRetornoDelRey = new Pelicula_No_tocar("El señor de los anillos: El retorno del rey", Genero.AVENTURA_FANTASIA, 2003, "254", "Peter Jakson", repartoESDLA_1_2_3, Pegi.TRECE, 4);
        Pelicula_No_tocar UnViajeInesperado = new Pelicula_No_tocar("El Hobbit: Un viaje inesperado", Genero.AVENTURA_FANTASIA, 2012, "182", "Peter Jakson", repartoELHobbit_1_2_3, Pegi.SIETE, 4);
        Pelicula_No_tocar LaDesolacionDeSmaug = new Pelicula_No_tocar("El Hobbit: La desolacion de Smaug", Genero.AVENTURA_FANTASIA, 2013, "186", "Peter Jakson", repartoELHobbit_1_2_3, Pegi.TRECE, 4);
        Pelicula_No_tocar LaBatallaDeLosCincoEjercitos = new Pelicula_No_tocar("El Hobbit: La batalla de los cinco ejercitos", Genero.AVENTURA_FANTASIA, 2014, "164", "Peter Jakson", repartoELHobbit_1_2_3, Pegi.DIECIOCHO, 4);
        Pelicula_No_tocar Gladiator = new Pelicula_No_tocar("Gladiator", Genero.ACCION, 2000, "155", "Ridley Scott", repartoGladiator, Pegi.TRECE, 4);
        Pelicula_No_tocar SalvarAlSoldadoRyan = new Pelicula_No_tocar("Salvar al soldado Ryan", Genero.BELICO, 1998, "169", "Steven Spielberg", repartoSalvarAlSoldadoRyan, Pegi.TRECE, 4);
        Pelicula_No_tocar TopGun = new Pelicula_No_tocar("Top Gun", Genero.ACCION, 1986, "110", "Tony Scott", repartoTopGun, Pegi.CERO,4);
        Pelicula_No_tocar TopGunMaverick = new Pelicula_No_tocar("Top Gun: Maverick", Genero.ACCION, 2022, "130", "Joseph Kosinski", repartoTopGunMaverick, Pegi.TRECE, 4);
        ...
        ArrayList<Pelicula_No_tocar> listaPeliculas = new ArrayList<>();
...
//    }
    ...
    public static void imprimirListaPeliculasForeach(ArrayList<Pelicula_No_tocar> lista){
        lista.forEach(peli -> {
