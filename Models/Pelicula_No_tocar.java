...
public class Pelicula_No_tocar {
    ...
    public Pelicula_No_tocar(String nombre, Genero genero, int anyoLanzamiento, String duracion, String director, ArrayList<String> reparto, Pegi pegi, float puntuacion) {
